...
def pre_level_1():
    ...
    level_1_background = pygame.image.load("assets/level_1/slides/slide_start_1.png")
    level_1_screen.blit(level_1_background, (0, 0))
    pygame.display.update()
    time.sleep(6)
    level_1_background = pygame.image.load("assets/level_1/slides/slide_start_2.png")
...
def level_1():
    game_paused = False
    level_1_screen = pygame.display.set_mode((WIDTH, HEIGHT))
    world = World("levels/level1/map.txt", 1, level_1_screen)
    clock = pygame.time.Clock()
    player_event = False
    level_1_background = pygame.image.load("assets/level_1/background/background.jpg")
    level_1_background = pygame.transform.scale(level_1_background, (WIDTH, HEIGHT))
    menu_button_list = list()
    resume_button_img = pygame.image.load("assets/menu_buttons/resume_button.png")
    resume_button = Button(430, 100, resume_button_img, 1.3, level_1_screen, lambda: ())
    menu_button_list.append(resume_button)
    restart_button_img = pygame.image.load("assets/menu_buttons/restart_button.png")
    restart_button = Button(430, 200, restart_button_img, 1.3, level_1_screen, lambda: ())
    menu_button_list.append(restart_button)
    back_to_menu_img = pygame.image.load("assets/menu_buttons/back_to_menu_button.png")
    back_to_menu_button = Button(430, 300, back_to_menu_img, 1.3, level_1_screen, lambda: ())
